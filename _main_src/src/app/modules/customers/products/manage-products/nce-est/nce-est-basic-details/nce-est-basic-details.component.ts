...
@Component({
  selector: 'app-nce-est-basic-details',
  templateUrl: './nce-est-basic-details.component.html',
  styleUrl: './nce-est-basic-details.component.scss'
})
export class NceEstBasicDetailsComponent extends C3BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.pageInfo.updateBreadcrumbs([('BREADCRUMB_TEXT_CUSTOMER_PRODUCTS'), ('NCEEST')])
  ...
  getProductDetails(product: any) {
    ...
    this._subscription = this._manageProductService.getProductDetails(product.InternalCustomerProductId).subscribe((response: any) => {//ajmal:todo: Nexted subscription
      ...
      this.showUpgradeButton = !(this.product.LinkedSubscriptionId != null && this.product.LinkedSubscriptionId != '' && this.product.LinkedSubscriptionId != undefined) || !this.product.IsEST;
