...
@Component({
    ...
    templateUrl: './disrtibutor.component.html',
    styleUrl: './disrtibutor.component.scss',
})
export class ProductDistributorComponent extends CustomerProductBaseComponent {
