...
export class ProductBundleComponent extends CustomerProductBaseComponent {
    userContext: any;
    EntityName: string;
    ...
    ngOnInit() {
        this.HasManageProduct =
            this._permissionService.hasPermission(
                ...
                ? this.userContext.RoleName.toLowerCase() ===
                    this.cloudHubConstants.ROLE_NAME_DEPARTMENT_READER ||
                    this.userContext.RoleName.toLowerCase() ===
                    this.cloudHubConstants.ROLE_NAME_SITE_READER ||
                    this.userContext.RoleName.toLowerCase() ===
                    this.cloudHubConstants.ROLE_NAME_CUSTOMER_READER
                    ? 'ReadOnly'
                    : 'Allowed'
                : this._permissionService.hasPermission(
                    this.cloudHubConstants.BTN_MANAGE_PRODUCT
