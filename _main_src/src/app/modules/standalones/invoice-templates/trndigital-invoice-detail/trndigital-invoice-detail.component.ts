...
@Component({
  selector: 'app-trndigital-invoice-detail',
  standalone: true,
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './trndigital-invoice-detail.component.html',
  styleUrl: './trndigital-invoice-detail.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TrndigitalInvoiceDetailComponent extends BaseInvoiceDetailComponent implements OnInit {
