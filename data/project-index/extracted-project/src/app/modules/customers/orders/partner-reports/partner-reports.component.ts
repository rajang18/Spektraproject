...
export class PartnerReportsComponent extends C3BaseComponent implements OnInit, OnDestroy {
  ...
  activeTab: PartnerReportsTabs = this.tabs.ReconciliationReport;

  setActiveTab(tab: PartnerReportsTabs) {
    this.activeTab = tab;
  }
  ...
  constructor(
    ...
    this.customerId = navigation?.extras.state?.['CustomerId'];
