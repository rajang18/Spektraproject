...
import { AccountingFormatPipe } from 'src/app/shared/pipes/accounting-format.pipe';
import { AppSettingsService } from 'src/app/services/app-settings.service';
import { C3DatePipe } from "../../../../shared/pipes/dateTimeFilter.pipe";

@Component({
  selector: 'app-tpt-invoice-detail',
  standalone: true,
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './tpt-invoice-detail.component.html',
  styleUrl: './tpt-invoice-detail.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TptInvoiceDetailComponent extends BaseInvoiceDetailComponent implements OnInit {
