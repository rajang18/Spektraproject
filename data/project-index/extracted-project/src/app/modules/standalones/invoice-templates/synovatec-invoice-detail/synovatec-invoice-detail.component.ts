...
@Component({
  selector: 'app-synovatec-invoice-detail',
  standalone: true,
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './synovatec-invoice-detail.component.html',
  styleUrl: './synovatec-invoice-detail.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SynovatecInvoiceDetailComponent extends BaseInvoiceDetailComponent implements OnInit {
