...
@Component({
  selector: 'app-davyntt-invoice-detail',
  standalone: true,
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './davyntt-invoice-detail.component.html',
  styleUrl: './davyntt-invoice-detail.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DavynttInvoiceDetailComponent extends BaseInvoiceDetailComponent implements OnInit {
