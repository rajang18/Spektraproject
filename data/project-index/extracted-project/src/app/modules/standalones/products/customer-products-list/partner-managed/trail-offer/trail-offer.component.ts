...
@Component({
  ...
  templateUrl: './trail-offer.component.html',
  styleUrl: './trail-offer.component.scss'
})
export class ProductTrailOfferComponent extends CustomerProductBaseComponent {
