...
@Component({
  selector: 'app-partner-quantity',
  standalone: true,
  imports: [NgbModule,TranslateModule,CurrencyPipe,C3CommonModule, CommonModule],
  templateUrl: './partner-quantity.component.html',
  styleUrl: './partner-quantity.component.scss'
})
export class PartnerQuantityComponent extends ProductBaseComponent {
