...
@Component({
  selector: 'app-purchase-product-mapping-products-popup',
  standalone: true,
  ...
  templateUrl: './purchase-product-mapping-products-popup.component.html',
  styleUrl: './purchase-product-mapping-products-popup.component.scss'
})
export class PurchaseProductMappingProductsPopupComponent implements OnInit,OnDestroy {
  ...
  Submit() {
    if(!this.c3Product.ContractServiceId){
