...
@Component({
  selector: 'app-entity-mapping-customer-name-pop-up',
  standalone: true,
  ...
  templateUrl: './entity-mapping-customer-name-pop-up.component.html',
  styleUrl: './entity-mapping-customer-name-pop-up.component.scss'
})
export class EntityMappingCustomerNamePopUPComponent implements OnInit,OnDestroy {
            ...
            .pipe(takeUntil(this.destroy$)).subscribe(({ Data }: any) => {
                ...
                if (this.purchasedProductMapping.CustomerId != null || this.purchasedProductMapping.CustomerId != undefined) {
                  ...
                  Data = Data.map((elm: any) =>({     
                    ...elm,
                    selectedCustomer: elm.ID === this.purchasedProductMapping.CustomerId          
                  })); 
                  this.selectedCustomer = _.find(this.activeCustomers,(e: any ) => {e.ID === this.purchasedProductMapping.CustomerId  });
              }
              }
              callback({
                data: Data,
