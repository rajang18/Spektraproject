...
@Component({
  selector: 'app-entity-mapping-psa-customer-popup',
  standalone: true,
  ...
  templateUrl: './entity-mapping-psa-customer-popup.component.html',
  styleUrl: './entity-mapping-psa-customer-popup.component.scss'
})
export class EntityMappingPSACustomerPopupComponent implements OnDestroy{
