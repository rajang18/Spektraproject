...
@Component({
  ...
  styleUrls: ['./online-service.component.scss','../online-service-nce/online-service-nce.component.scss']
})
export class ManageOnlineServiceComponent extends ProductBaseComponent {
