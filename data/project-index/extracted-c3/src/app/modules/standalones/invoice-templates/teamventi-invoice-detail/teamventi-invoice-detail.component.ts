...
@Component({
  selector: 'app-teamventi-invoice-detail',
  standalone: true,
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './teamventi-invoice-detail.component.html',
  styleUrl: './teamventi-invoice-detail.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TeamventiInvoiceDetailComponent extends BaseInvoiceDetailComponent implements OnInit {
