...
@Component({
  selector: 'app-resolution-it-invoice-detail',
  standalone: true,
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './resolution-it-invoice-detail.component.html',
  styleUrl: './resolution-it-invoice-detail.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ResolutionItInvoiceDetailComponent extends BaseInvoiceDetailComponent implements OnInit {
